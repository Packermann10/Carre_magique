...
//BUT: créer un carré magique de valeur 5x5
//ENTREE: la valeur du carré (ici 5)
//SORTIE: le carré voulu
...
//BUT: créer un carré magique de valeur 7x7
//ENTREE: la valeur du carré (ici 7)
//SORTIE: le carré voulu
